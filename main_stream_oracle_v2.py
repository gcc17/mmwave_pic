...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/mmfi_stream_oracle_v2.yaml', help='path to config file')
    ...
    select_name = f'new_ratio{config.strategy.select_ratio}'
    ...
    for epoch in range(config.train.n_epochs):
        if epoch % config.strategy.select_freq == 0:
            ...
            new_indices = np.concatenate((existing_selected_indices, converted_selected_indices))
