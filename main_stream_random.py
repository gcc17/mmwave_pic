...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/stream_random.yaml', help='path to config file')
    ...
    # set up tensorboard
    select_name = f'seed{args.random_seed}'
    ...
    for epoch in range(config.train.n_epochs):
        ...
        if epoch % config.strategy.select_freq == 0:
            ...
            random_indices = np.random.choice(total_indices, each_iter_select_cnt, replace=False)
